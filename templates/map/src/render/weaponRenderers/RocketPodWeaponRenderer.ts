...
export const UB32_DEVIATION = UB32_MOA / 60 * Math.PI / 180 / 2; // cone angle from center ~ "radius angle"
 ...
 * 空对地火箭弹系统，具有大范围杀伤力
 */
export class RocketPodWeaponRenderer extends BaseWeaponRenderer {
  weaponType = "ub32";
  
  // 实现基类抽象方法 - 武器常量
  getVelocity(): number { return UB32_VELOCITY; }
  getGravity(): number { return S5_GRAVITY; }
  getDeviation(): number { return UB32_DEVIATION; }
  getMinRange(): number { return 0; } // UB32无最小射程限制
  getMaxRange(): number { return 50000; } // 估计最大射程
  get100DamageRange(): number { return S5_EXPLOSIVE_INNER_RADIUS; }
  get25DamageRange(): number { return S5_EXPLOSIVE_OUTER_RADIUS; }
