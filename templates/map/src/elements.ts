...
import {
  ...
  ACCELERATION,
  ACCELERATION_TIME
} from "./render/weaponRenderers/UB32WeaponRenderer";
...
export const $s5map = new FiringSolutionTable("s5_low.png", $s5image, $s5canvas, DEVIATION, VELOCITY, ACCELERATION, ACCELERATION_TIME);
